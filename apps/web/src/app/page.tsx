      ...
      <main className="flex w-full max-w-4xl flex-col gap-8">
        ...
        <Card className="p-8 bg-card">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-primary mb-4">📊 PAPERTRADER</h1>
            <p className="text-xl text-card-foreground">Options Paper Trading Platform</p>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 bg-card">
            <div className="text-center">
              ...
              <p className="text-sm text-card-foreground">
                Real-time options chains and market data
              </p>
            </div>
          </Card>
          ...
          <Card className="p-6 bg-card">
            <div className="text-center">
              ...
              <p className="text-sm text-card-foreground">
                Advanced options analytics and insights
              </p>
            </div>
          </Card>
        ...
        <Card className="p-8 bg-card">
          <div className="flex flex-col items-center gap-6">
            <h2 className="text-3xl font-bold text-primary text-center">Get Started</h2>
            <p className="max-w-2xl text-center text-lg text-card-foreground">
              View live options chains, analyze Greeks, and practice trading strategies without
              risking real money.
            </p>
